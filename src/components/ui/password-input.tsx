...
import {Box, HStack, IconButton, Input, InputGroup, mergeRefs, Stack, useControllableState,} from "@chakra-ui/react"
...
function getColorPalette(percent: number) {
    switch (true) {
        ...
        case percent < 67:
            return {label: "Mediana", colorPalette: "yellow"}
        case percent < 99:
            return {label: "Muito Forte", colorPalette: "green"}
        default:
            return {label: "Muito Forte", colorPalette: "teal"}
    }
}
